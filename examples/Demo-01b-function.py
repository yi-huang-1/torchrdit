"""
# Updated Example 1 - GMRF with hexagonal unit cells using RCWA (Function-based Builder)

This example shows the simulation of the guided-mode resonance filter (GMRF) 
using torchrdit with the function-based Builder pattern and a configuration function.
"""
...
def configure_gmrf_solver(builder):
    """Configure a builder for a GMRF solver with hexagonal unit cells."""
    # Lattice vectors
...
torchrdit_sim = create_solver_from_builder(configure_gmrf_solver)
